...
class IntentResolveClient {
    ...
    fun resolveTalkIntent(context: Context, intent: Intent): Intent? {
        ...
        val chooserIntent = Intent.createChooser(labeledIntents.removeAt(0), "Which version of KakaoTalk would you like to use?")
    ...
    private val SANDBOX_TALK_PACKAGE_NAME = "com.kakao.talk.sandbox"
    private val ALPHA_TALK_PACKAGE_NAME = "com.kakao.talk.alpha"

    private val ALLOWED_SIGNATURES =
            arrayOf(RELEASE_SIGNATURE, DEBUG_SIGNATURE, ONE_RELEASE_SIGNATURE)

    private val ALLOWED_PACKAGES = arrayOf(TALK_PACKAGE_NAME, ONE_TALK_PACKAGE_NAME, SANDBOX_TALK_PACKAGE_NAME, ALPHA_TALK_PACKAGE_NAME)
