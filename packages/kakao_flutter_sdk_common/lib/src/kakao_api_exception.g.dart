...
const _$ApiErrorCauseEnumMap = {
  ...
  ApiErrorCause.notStoryUser: -601,
  ApiErrorCause.storyImageUploadSizeExceeded: -602,
  ApiErrorCause.timeOut: -603,
  ApiErrorCause.storyInvalidScrapUrl: -604,
  ApiErrorCause.storyInvalidPostId: -605,
