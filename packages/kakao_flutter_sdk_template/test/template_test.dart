...
import 'package:kakao_flutter_sdk_template/src/feed_template.dart';
import 'package:kakao_flutter_sdk_template/src/location_template.dart';
  ...
  test('location', () {
    final template = LocationTemplate(
      ...
      buttons: [
        Button(
          title: '웹으로 보기',
          link: Link(webUrl: Uri.parse('https://map.kakao.com/link/map/0,0')),
        ),
      ],
